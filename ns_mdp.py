# This module includes NSMDP class
...
class NSMDP(MDP):
    ...
    def __init__(self, transition_prob, rewards, n_state, n_action):
        ...
        """
        Construction of the Non-Stationary MDPs

        :param transition_prob: 4D Array
        :param rewards: 3D Array
    ...
    def transition_probability_check(self):
        ...
        _, s_from, action, s_to = self.transition_probs.shape
        ...
        sum_ = [np.sum(self.transition_probs[t, s, a, :]) for t in range(_) for s in self.states for a in self.actions]
